...
import {createSubscriptionPlan} from "../../services/subscriptionsPlanService.js";
...
const SubscriptionPlanAddDialog = ({open, onClose}) => {
        ...
        <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth
            ...
            <DialogTitle sx={{px: 3, pt: 3, pb: 1}}>
                <div className="flex items-start justify-between">
                    <div>
                        <h2 className="text-lg font-bold text-gray-900 leading-tight">Add Subscription Plan</h2>
                        <p className="text-sm text-gray-400 font-normal mt-0.5">Fill in the plan details below</p>
                    </div>
            ...
            <DialogContent sx={{px: 3, py: 2.5}}>
                <form className="flex flex-col gap-4" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <TextField label="Plan Code" {...register("planCode")}
                                   error={!!errors.planCode} helperText={errors.planCode?.message}
                ...
                {loading && (
                    <Backdrop sx={{color: '#6366f1', zIndex: (t) => t.zIndex.drawer + 1, backgroundColor: 'rgba(255,255,255,0.4)', backdropFilter: 'blur(8px)'}}
                              open={loading}>
                        <Loader text="Creating Subscription Plan..."/>
                    </Backdrop>
                )}
            </DialogContent>
        </Dialog>
...
export default SubscriptionPlanAddDialog;